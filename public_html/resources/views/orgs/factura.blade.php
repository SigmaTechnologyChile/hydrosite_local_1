...
@section('content')
    ...
    <style>
        ...
        .container-boleta { /* Renombrado de .invoice-container para mantener la coherencia con el ejemplo de boleta */
            max-width: 800px;
            margin: 20px auto;
            padding: 20px;
        ...
        @media print {
            ...
            @page {
                /* Margenes para A4 y Carta. Un margen de 10mm-15mm es común y permite espacio. */
                /* Para Carta (215.9mm x 279.4mm) o A4 (210mm x 297mm) */
                margin: 10mm !important;
                padding: 0mm !important;
            }

            .container-boleta {
                width: auto !important; /* Permitir que el ancho se ajuste con los márgenes */
                max-width: 190mm !important; /* Para A4 (210mm - 2*10mm) */
                height: auto !important; /* Permitir que la altura se ajuste */
                max-height: 277mm !important; /* Para A4 (297mm - 2*10mm) */
                padding: 5mm !important; /* Un padding interno razonable */
                margin: 0 auto !important; /* Centrar el contenedor */
                border: none;
                box-shadow: none;
                background-color: #fff !important;
                display: block !important; /* Asegurar que se muestre como bloque normal */
                box-sizing: border-box !important;
                page-break-inside: avoid !important; /* Prevenir que se rompa el contenedor principal */
            }

            /* Ajustar tamaños de fuente y espaciados para A4/Carta */
            p, td, th, .small {
                font-size: 0.8em !important; /* Ajuste de tamaño de fuente general */
                line-height: 1.2 !important; /* Espaciado de línea más holgado para legibilidad */
                margin-bottom: 0.3mm !important; /* Reducir márgenes inferiores */
            }
            .table-custom th, .table-custom td {
                padding: 1mm 2mm !important; /* Reducir padding en tablas */
            }
            h5 { font-size: 1em !important; }
            h6 { font-size: 0.9em !important; } /* Ajuste de encabezados */

            .p-3 { padding: 3mm !important; } /* General padding reductions */
            ...
            .logo-info img {
                max-width: 30mm !important; /* Tamaño de logo para A4 */
                max-height: 30mm !important;
                margin-right: 3mm !important;
            }
            .rut-box {
                padding: 3mm !important; /* Ajuste de padding en RUT box */
            }
            .alert-info-custom {
                padding: 3mm 5mm !important; /* Ajuste de padding en alerta */
                margin-top: 2mm !important;
                margin-bottom: 2mm !important;
            }

            .chart-container {
                height: 30mm !important; /* Altura adecuada para el gráfico */
                max-height: 30mm !important;
            ...
            .row-flex {
                margin-bottom: 2mm !important; /* Espaciado de fila */
            }
            .col-flex-50, .col-flex-40, .col-flex-60, .col-flex-70, .col-flex-30, .col-flex-100 {
                padding: 1mm !important; /* Reducir padding de columna */
                page-break-inside: avoid !important;
            }
            /* Explicit widths for flex columns, essential for predictable layout on A4/Carta */
            ...
            .text-primary, .text-danger, .text-success {
                -webkit-print-color-adjust: exact !important;
                print-color-adjust: exact !important;
                background-color: inherit !important; /* Se mantiene el background-color */
                color: inherit !important; /* Se mantiene el color del texto */
            }
