    ...
    <body>
        <div class="container">
          <div class="vertical-center">
              ...
              <img src="{{url('/WebpayPlus_FB_300px.png')}}">
                @if ($url)
                <form name="brouterForm" id="brouterForm"  method="POST" action="{{$url}}" style="display:block;">
                  <input type="hidden" name="token_ws" value="{{$token}}" />
                  <input type="submit" value="Cargando..." style="border: 1px solid #6b196b;
    border-radius: 4px;
